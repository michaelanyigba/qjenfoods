                ...
                <form action="password_reset_code.php" method="post">
                  <h5 class="fw-normal mb-2 pb-2" style="letter-spacing: 1px;">Reset your password</h5>
                    ...
                    if (isset($_SESSION['message'])) {
                        echo "<div id='flash-message' class='message {$_SESSION['msg_type']}'>" . $_SESSION['message'] . "</div>";
                  ...
                  <label class="form-label">Email address</label>
                    <input type="email" name="email" autocomplete="off" class="form-control form-control-lg" />
                  </div>
                  <div class="pt-1 mb-4">
                    <button data-mdb-button-init data-mdb-ripple-init class="btn btn-dark btn-lg btn-block" name="password_reset_link" type="submit">Send password link</button>
                  </div>
