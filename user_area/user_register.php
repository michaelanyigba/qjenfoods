...
if(isset($_POST['register_user'])){
    ...
    $conf_user_password= $_POST['user_confirm_password'];
        ...
        <div class="card" style="border-radius: 1rem;">
          <div class="row g-0">
            <div class="col-md-6 col-lg-5 d-none d-md-block">
              <img src="img/register_img.jpg"
                alt="login form" class="img-fluid py-10" style="border-radius: 1rem 0 0 1rem; margin-top: 190px; margin-left: 30px;" />
            </div>
              ...
              <h5 class="fw-normal mb-2 pb-2" style="letter-spacing: 1px;">Register your account</h5>
                ...
                <form method="post" autocomplete="off">
                  ...
                  <label class="form-label">Address </label>
                    <input type="text" autocomplete="off" name="user_address" class="form-control form-control-lg" />
                  </div>
                  <div data-mdb-input-init class="form-outline mb-2">
                  <label class="form-label">Phone number </label>
                    <input type="number" name="user_phone_number" autocomplete="off" class="form-control form-control-lg" />
                  </div>
