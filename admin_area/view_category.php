  ...
  <body>
    <div id="wrapper">
      ...
      <div id="page-wrapper">
        <div id="page-inner">
          ...
          <div id="success-alert-delete" class="success-alert">Category deleted successfully!</div>
    ...
    ?>
                      <tr>
                        ...
                        <?php
                        if($_SESSION['role'] ==="admin"){
                          echo "<td><a href='edit_category.php?edit_category=$category_id'><i class='fa fa-pencil pencil'></i></a></td>
                        <td><a onclick='confirmDelete($category_id)'><i class='fa fa-trash-o trash' aria-hidden='true'></i></a></td>
";
                        }
