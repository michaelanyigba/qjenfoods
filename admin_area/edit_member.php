...
if(isset($_GET['edit_member'])){
    ...
    $get_data = "Select * from `users` where user_id = $edit_member_id";
...
if(isset($_POST['update_user'])){
    ...
    if($username ==''){
        ...
        // $update_user = "update `users` set username = '$username', user_email='$user_email', user_password='$hash_password' where user_id = $edit_member_id";
        // $result_update = mysqli_query($con, $update_user);
        $update_user = $con->prepare("UPDATE `users` SET username= ?, user_email=?, user_password=? WHERE user_id = ?");
        $update_user->bind_param("sssi", $username, $user_email, $hash_password, $edit_member_id);
            ...
            ?>
               <form method="post" autocomplete="off">
                  ...
                  <label class="form-label">Username</label>
                    <input type="text" value="<?php echo $username?>" autocomplete="off" name="user_username" class="form-control form-control-lg" />
                  </div>
                  <div data-mdb-input-init class="form-outline register_user_input_div">
                  <label class="form-label">Email </label>
                    <input type="email" value="<?php echo $user_email?>"  autocomplete="off" name="user_email" class="form-control form-control-lg" />
                  </div>
                  <div data-mdb-input-init class="form-outline register_user_input_div">
                  ...
                  <div class="pt-1 mb-4">
                    <button class="btn btn-dark register_member_btn" name="update_user" type="submit">Update</button>
                  </div>
                </form>
           </div>
           <!-- form ends -->
