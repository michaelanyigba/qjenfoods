...
<head>
    ...
    <!-- Favicon -->
    <link href="./user_area/img/favicon.ico" rel="icon">
    ...
    <link href="./user_area/lib/owlcarousel/assets/owl.carousel.min.css" rel="stylesheet">

    <!-- Customized Bootstrap Stylesheet -->
    <link href="./user_area/css/style.css" rel="stylesheet">
    <link href="./user_area/css/responsive.css" rel="stylesheet">
</head>
...
<body>
    ...
    <div class="container-fluid">
        <div class="row bg-secondary py-1 px-xl-5">
            ...
            <div class="col-lg-6 text-center text-lg-right">
                ...
                <div class="d-inline-flex align-items-center d-block d-lg-none">
                    <a href="./user_area/cart.php" class="btn px-0 ml-2">
        ...
        <div class="row align-items-center bg-light py-3 px-xl-5 d-none d-lg-flex">
            ...
            <div class="col-lg-4 col-6 text-left">
                <form action="./user_area/search_product.php" method="get" id="search_data_product">
        ...
        <!-- search end -->
            <div class="col-lg-4 col-6 text-right">
                ...
                <h5 class="m-0">+233 59 308 316</h5>
            </div>
        </div>
    </div>
    <!-- Topbar End -->
                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="./user_area/shop.php" class="nav-item nav-link">Shop</a>
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Pages <i class="fa fa-angle-down mt-1"></i></a>
                                <div class="dropdown-menu bg-primary rounded-0 border-0 m-0">
                                    <a href="./user_area/cart.php" class="dropdown-item">Shopping Cart</a>
                                </div>
                            </div>
                            <a href="./user_area/contact.php" class="nav-item nav-link">Contact</a>
                        </div>
                        <div class="navbar-nav ml-auto py-0 d-none d-lg-block">
                            <a href="./user_area/cart.php" class="btn px-0 ml-3">
    ...
    <!-- search bar -->
    <div class="col-lg-4 col-md-8 col-12 text-center mb-2 responsive-search-bar">
                <form action="./user_area/search_product.php" method="get" id="search_data_product">
                    <div class="input-group">
                        <input type="text" class="form-control" id="searchInput" placeholder="Search for products" name="search_data" autocomplete="off">
                        <div class="input-group-append">
                            <span class="input-group-text bg-transparent text-primary">
                                <!-- <i class="fa fa-search" id="searchIcon" name="search_data_product" onclick="submitForm()"></i>
                                 <input type="submit" id="hiddenSubmit" name="search_data_product" style="display:none"> -->
                                 <button type="submit" class="search-btn" name="search_data_product"><i class="fa fa-search"></i></button>
        ...
        <div class="row px-xl-5 pb-3">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div class="d-flex align-items-center bg-light mb-4" style="padding: 30px;">
                    ...
                    <h5 class="font-weight-semi-bold m-0">Delivery Available</h5>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div class="d-flex align-items-center bg-light mb-4" style="padding: 30px;">
                    <h1 class="fas fa-exchange-alt text-primary m-0 mr-3"></h1>
                    <h5 class="font-weight-semi-bold m-0">Product Return</h5>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div class="d-flex align-items-center bg-light mb-4" style="padding: 30px;">
    ...
    <div class="container-fluid pt-5 pb-3">
        ...
        <div class="row px-xl-5">
            <!-- calling getting product function will come here -->
             <?php
             get_products();
             ?>
        </div>
            ...
            <div class="col">
                <div class="owl-carousel vendor-carousel">
                    <div class="bg-light p-4">
                        <img src="./user_area/img/vendor-1.jpg" alt="">
                    </div>
                    <div class="bg-light p-4">
                        <img src="./user_area/img/vendor-2.jpg" alt="">
                    </div>
                    <div class="bg-light p-4">
                        <img src="./user_area/img/vendor-3.jpg" alt="">
                    </div>
                    <div class="bg-light p-4">
                        <img src="./user_area/img/vendor-4.jpg" alt="">
                    </div>
                    <div class="bg-light p-4">
                        <img src="./user_area/img/vendor-5.jpg" alt="">
                    </div>
                    <div class="bg-light p-4">
                        <img src="./user_area/img/vendor-6.jpg" alt="">
                    </div>
                    <div class="bg-light p-4">
                        <img src="./user_area/img/vendor-7.jpg" alt="">
                    </div>
                    <div class="bg-light p-4">
                        <img src="./user_area/img/vendor-8.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-md-4 mb-5">
                        ...
                        <div class="d-flex flex-column justify-content-start">
                            ...
                            <a class="text-secondary mb-2" href="./user_area/shop.php"><i class="fa fa-angle-right mr-2"></i>Our Shop</a>
                            <a class="text-secondary mb-2" href="./user_area/cart.php"><i class="fa fa-angle-right mr-2"></i>Shopping Cart</a>
                            <a class="text-secondary" href="./user_area/contact.php"><i class="fa fa-angle-right mr-2"></i>Contact Us</a>
                        </div>
                    </div>
                    <div class="col-md-4 mb-5">
                        <h5 class="text-secondary text-uppercase mb-4">My Account</h5>
                        <div class="d-flex flex-column justify-content-start">
                            <a class="text-secondary mb-2" href="./user_area/profile.php"><i class="fa fa-angle-right mr-2"></i>My Profile</a>
                            <a class="text-secondary mb-2" href="./user_area/profile.php"><i class="fa fa-angle-right mr-2"></i>My Orders</a>
                        </div>
                    </div>
                    <div class="col-md-4 mb-5">
    ...
    <script src="./user_area/mail/jqBootstrapValidation.min.js"></script>
    <script src="./user_area/mail/contact.js"></script>

    <!-- Template Javascript -->
    <script src="./user_area/js/main.js"></script>
    <script>
        function submitForm() {
